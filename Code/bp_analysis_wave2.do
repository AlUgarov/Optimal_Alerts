...
keep participant_id bp_* bp_time_* sex age stat_educ ncorrect informed_correct wtpq_correct educ wave
...
save "./Temp/blind_prot_temp_all.dta", replace
...
save "./Temp/blind_collapsed_all.dta", replace

use "./Temp/bp_val_all.dta", replace
gen pilot=0
...
graph export "./Graphs/blind_prot_sta_all.png", width(1000) height(1000) replace

gen task_type="Blind"
rename p post_prob
keep mean post_prob se task_type
save "./Temp/bp_graph_data_all.dta", replace
