...
collapse (median) wtp value wtp_diff (sd) wtpsd=wtp (first) p phintWB phintBW (count) nobs=wtp, by(treatn)
...
graph twoway (scatter wtp_ phintWB if var_origin==3&plevel==10) (scatter wtp_ phintWB if var_origin==3&plevel==10)
graph twoway (scatter wtp_ phintWB if var_origin==3&plevel==20) (scatter wtp_ phintWB if var_origin==3&plevel==20)
graph twoway (scatter wtp_ phintWB if var_origin==3&plevel==30) (scatter wtp_ phintWB if var_origin==3&plevel==30)
log close
