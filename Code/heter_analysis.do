...
drop if plevel>200 //dropping second probs in each sequence of treatments
...
logit ip_ phigh i.subject_id if alt==1 //not matching estimates
...
lclogit2 ip_ alt if plevel<300, rand(phigh_hintd false_prob phigh) group(choice_id) id(subject_id) nclasses(2) constraints(1 2 3) seed(10001)
local akaike1=e(aic)
local nclasses=1
matrix coeff=e(b)
display(`akaike1')
...
forvalues nclasses = 2/4 {
  lclogit2 ip_ alt if plevel<300, rand(phigh_hintd false_prob phigh) group(choice_id) id(subject_id) nclasses(`nclasses') seed(10001)
  local akaike1=e(aic)
  display(`akaike1')
  local bic=e(bic)
  display(`bic')
  ...
  matrix class_compar = nullmat(class_compar) \ `nclasses', `bic', `akaike1', `akaike_cor'
  matrix start = e(b)
  lclogitml2 ip_ alt if plevel<300, rand(phigh_hintd false_prob phigh) group(choice_id) id(subject_id) nclasses(`nclasses')  from(start)
}
...
lclogit2 ip_ alt if plevel<300, rand(phigh_hintd false_prob phigh) group(choice_id) id(subject_id) nclasses(2) seed(10001)
local akaike1=e(aic)
local nclasses=2
display(`akaike1')
local bic=e(bic)
...
display(`akaike_cor')
matrix start = e(b)
lclogitml2 ip_ alt if plevel<300, rand(phigh_hintd false_prob phigh) group(choice_id) id(subject_id) nclasses(2)  from(start)
...
lclogit2 ip_ alt if plevel<300, rand(phigh_hintd false_prob phigh) group(choice_id) id(subject_id) nclasses(3) seed(10001)
local akaike1=e(aic)
local nclasses=3
display(`akaike1')
local bic=e(bic)
...
display(`akaike_cor')
matrix start = e(b)
lclogitml2 ip_ alt if plevel<300, rand(phigh_hintd false_prob phigh) group(choice_id) id(subject_id) nclasses(3)  from(start)
display("coefficients:")
matrix coeff=e(b)
matrix shares=e(P)
matrix list coeff
...
logit ip_ i.blackhint##c.phintBW i.blackhint##c.phintWB i.plevel if plevel<300, vce(cluster subject_id)
predict ip_base
...
gen ip_all=ip_
replace ip_=. if plevel>200

lclogit2 ip_ alt if plevel<300, rand(phigh_hint phintWB0 phintBW0 phintWB1  phintBW1) group(choice_id) id(subject_id) nclasses(2) seed(10001)
local akaike1=e(aic)
local nclasses=2
display(`akaike1')
local bic=e(bic)
...
display(`akaike_cor')
matrix start = e(b)
lclogitml2 ip_ alt if plevel<300, rand(phigh_hint phintWB0 phintBW0 phintWB1  phintBW1) group(choice_id) id(subject_id) nclasses(2)  from(start)
display("coefficients:")
matrix coeff=e(b)
matrix shares=e(P)
matrix list coeff
...
lclogitpr2 classpr if plevel<300, cp
sum classpr*
...
*prior probabilities:
lclogitpr2 pr if plevel<300, pr
...
tab class stat_educ if first==1&plevel<300, chi2

eststo clear
eststo: logit ip_ blackhint phintWB0 phintBW0 phintWB1  phintBW1 if alt==1&plevel<300, vce(cluster subject_id)
...
eststo: logit ip_ blackhint phintWB0 phintBW0 phintWB1  phintBW1 if alt==1&class==1&plevel<300, vce(cluster subject_id)
local r2p=e(r2_p)
local llike=e(ll)
predict ip_class1
...
eststo: logit ip_ blackhint phintWB0 phintBW0 phintWB1  phintBW1 if alt==1&class==2&plevel<300, vce(cluster subject_id)
local r2p=e(r2_p)
local llike=e(ll)
predict ip_class2
