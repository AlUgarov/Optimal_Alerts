...
We use a laboratory experiment to examine preferences over these trade-offs and study the demand for information of a known quality for a protection decision. The subject receives information about the prior probability of an adverse event and decides whether to take a protective action after receiving a signal with a known quality (i.e., false-positive/negative rates). We then elicit their willingness to pay (WTP) for signals of varying quality. We find that subjects' WTP is weakly correlated with the value of information. Subjects on average underreact to the quality of the signal, resulting in overpaying for low-quality signals and underpaying for high-quality signals. Additionally, subjects tend to overreact to false-negative rates when the prior probability is low and overreact to false-positive positive rates when priors are high. We find that this pattern is most consistent with a failure to estimate the effect of the frequencies of false-positive and false-negative outcomes on the potential costs of using the signal. 
