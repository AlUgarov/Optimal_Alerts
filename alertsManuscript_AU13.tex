...
From here on, the paper proceeds in a mostly straightforward manner. We start by setting up a simple model and outlining our hypotheses in Section 2. Section 3 describes the experimental design. Next, given a novelty of some of the experimental tasks, we present our results in three consecutive sections. Section 4 gives theory-free exposition of subjects' choices in all the experimental treatments. Section 5 describes the results for main empirical tests of this paper with regards to the willingness-to-pay for signals. Finally, Section 6 explores potential explanations for the observed pattern of underreaction to false-positive rates for low initial probabilities.
