...
\begin{itemize}
\item Consistent subjects do not show significant biases in either FP or FN sensitivity both an average and for low/high priors!
\end{itemize}
\begin{table}[htbp!]
\centering
...
\begin{itemize}
\item The observed WTP biases we observe mostly come a large group of subjects making inconsistent choices 
\item Indicates that biases have cognitive origins - paying for a signals and not using it is hard to explain just from preferences
